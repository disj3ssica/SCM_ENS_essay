...
is the true design flaw of caused by joint optimization of donor and 
predictors weights. Their proposed solution is to determine predictor and donor 
...
fails to derive optimal weights even when predictor weights are given). The
...
reveals the computational difficulty of problem that is a NP-hard bilevel 
