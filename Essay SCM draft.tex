...
%Abadie and Gardeazabal (2003) and Abadie et al. (2010) state that weights 
%should be chosen so that the resulting synthetic unit resembles the 
%pre-intervetion values of predictors for the treated unit as closely as possible. 
...
$\mathbf{W}(\mathbf{V})=\left(w_2(\mathbf{V}),...,w_{J+1}(\mathbf{V})\right)'$. 
