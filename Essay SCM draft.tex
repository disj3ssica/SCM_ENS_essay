...
\section{Introduction} % TO FINISH
...
\section{Synthetic Control Methods}  % PROOFREADING DONE
...
\section{Effectiveness of SCM: challenges and remedies}   % PROOFREADING DONE
...
\section{Applying SCM to the analysis of extreme natural events}  % PROOFREADING DONE
...
\section{Applying SCM to evaluate environmental policy}   % PROOFREADING DONE
...
\section{Potential applications to Fleurbeay project} % TO FINISH
\textcolor{red}{Lorem ipsum}



\section{Conclusion}  % TO FINISH
\textcolor{red}{Lorem ipsum}
